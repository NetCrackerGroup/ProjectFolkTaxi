...
VALUES ('spring-security-oauth2-read-client', '',
        ...
        'read', 'password,authorization_code,refresh_token,implicit', 'USER, ADMIN', 10000, 2592000);
...
VALUES ('spring-security-oauth2-read-write-client', '',
        ...
        'read,write', 'password,authorization_code,refresh_token,implicit', 'USER', 10000, 2592000);
